...
class ScaleX extends React.Component<any, any, any> {
  render() {
    return (
...
class PlayToggle extends React.Component<any, any, any> {
  _handlePlayToggle = () => {
  ...
  render() {
    ...
    return (
      <svg
        ...
        viewBox="0 0 36 36"
        className={className}
        onClick={this._handlePlayToggle}
      >
...
export default withMediaProps(PlayToggle);
